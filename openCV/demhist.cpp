...
static void updateBrightnessContrast( int /*arg*/, void* ){
    ...
    imshow("image", dst);
    imwrite("demhist_output.jpg", dst);
    ...
    imwrite("demhistHistogram_result.jpg", histImage);
}
static void help(){
    cout << "\nThis program demonstrates the use of calcHist() -- histogram creation.\n"
              << "Usage: \n" << "demhist [image_name -- Defaults to baboon.jpg]" << endl;
}
...
int main( int argc, const char** argv ){
    ...
    if(image.empty()){
        cerr << "Cannot read image file: " << inputImage << endl;
        return -1;
    }
    ...
    updateBrightnessContrast(50, 0);
    updateBrightnessContrast(75, 0);
